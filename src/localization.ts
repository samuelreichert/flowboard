...
const enMessages = {
  ...
  board: {
    ...
    emptyBoardTitle: 'Set up your first column',
    ...
    moreColumnActions: (columnTitle: string) =>
      `More actions for ${columnTitle}`,
...
const ptBrMessages: Messages = {
  ...
  board: {
    ...
    createFirstColumn: 'Criar primeira coluna',
    emptyBoardDescription:
      'Crie uma coluna para dar ao compositor um destino para novos cartões.',
    emptyBoardTitle: 'Configure sua primeira coluna',
    ...
    moreColumnActions: (columnTitle) => `Mais ações para ${columnTitle}`,
    moveColumnLeft: 'Mover para a esquerda',
    moveColumnRight: 'Mover para a direita',
    moveColumnToEnd: 'Mover para o final',
    moveColumnToStart: 'Mover para o início',
